...
[`DataStructure`](https://github.com/crazyuploader/C/tree/master/DataStructure) directory contains Data Structure header files which are used in main.c using C.
